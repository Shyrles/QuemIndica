            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-3 mx-auto my-md-4 my-0 mt-4 mb-1">
                    ...
                    <ul class="list-unstyled endereco">
                        <li><p> São Paulo, 01010-010</p></li>
                        <li><p> contato@quemindica.com.br</p></li>
                        <li><p> + 55 11 0000-000</p></li>
                    </ul>
                </div>

                <div class="col-md-2 col-lg-2 text-center mx-auto my-4">
                <h6 class="font-weight-bold text-uppercase mb-4">Na Web</h6>
                    <a href="https://www.facebook.com" target="_blank"><img src="imagens/facebook.png" alt="Facebook"></a>
